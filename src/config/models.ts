...
With both an x8 and x16 PCIe Gen3 connection, the possibilities are endless!`,
  ...
  },
  {
    ...
    position: [0, -1.5, -1.17],
    rotation: [0, THREE.MathUtils.degToRad(-90), 0],
    componentOpenPosition: [0, -2.2, -1.75],
    scale: 0.13,
        ...
        hotspots: [
          {
            scale: 7,
            title: `NIC TRAY`,
            description: `The fan tray is the carrier for fan modules. Each fan tray carries 6 fans. It also carries the fan board that manages the fans. The fan trays are also rear accessible but not hot swappable.`,
            rotation: [0, THREE.MathUtils.degToRad(90), 0],
            position: [-2, 1.9, 0.8],
          },
        ],
